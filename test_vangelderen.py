...
print(vg.vangelderen_cylinder_perp(D_invivo, 0.5*3.3e-6, scheme_clinical, m_max=10))
# 5% signal drop for D_min = 4.9 um with scheme_clinical
print(vg.vangelderen_cylinder_perp(D_invivo, 0.5*4.9e-6, scheme_clinical, m_max=10))
# 1% signal drop for D_min = 1.7 um with scheme_connectom
print(vg.vangelderen_cylinder_perp(D_invivo, 0.5*1.7e-6, scheme_connectom, m_max=10))
